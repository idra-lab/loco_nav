...
class PlannerBase:
    ...
    def ros_init(self, start_simulation=False, regenerate_map=True, launch_file=None, custom_args=[]):
        if start_simulation:
            self.startSimulation(regenerate_map=regenerate_map, launch_file=launch_file, custom_args=custom_args)
    ...
    def startSimulation(self, regenerate_map=True, launch_file=None, custom_args=[]):
        ...
        additional_args.extend(custom_args)
