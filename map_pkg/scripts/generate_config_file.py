...
def generate_config_file(map_env_params_file, generated_config_file):
    ...
    full_conf_file["/**/send_obstacles"]["ros__parameters"]["vect_type"] = [str(obstacle.type) for obstacle in
                                                                            obstacles]
    ...
    full_conf_file["/**/send_obstacles"]["ros__parameters"]["vect_yaw"] = [float(obstacle.yaw) for obstacle in
                                                                           obstacles]
    full_conf_file["/**/send_obstacles"]["ros__parameters"]["vect_dim_x"] = [float(obstacle.dx) for obstacle in
                                                                             obstacles]
    full_conf_file["/**/send_obstacles"]["ros__parameters"]["vect_dim_y"] = [float(obstacle.dy) for obstacle in
                                                                             obstacles]
    ...
    full_conf_file["/**/send_victims"]["ros__parameters"]["victims_activated"] = \
    ...
    if config_yaml['/**/send_victims']['ros__parameters']['victims_activated']:
        ...
        full_conf_file["/**/send_victims"]["ros__parameters"]["vect_weight"] = [float(victim.weight) for victim in
                                                                                victims]
...
def Configurator():
    ...
    if generate_new_config:
        ...
        rospy.loginfo("Config file generated.")
    else:
