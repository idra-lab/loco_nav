...
{
public:
    Sendgates(ros::NodeHandle &nh)
    {
        pub_ = nh.advertise<obstacles_msgs::ObstacleArrayMsg>("gates", 10);
        timer_ = nh.createTimer(ros::Duration(1.0), &Sendgates::timerCallback, this);
    }
