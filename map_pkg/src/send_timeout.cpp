...
{
public:
    Sendtimeout(ros::NodeHandle &nh)
    {
        pub_ = nh.advertise<obstacles_msgs::ObstacleArrayMsg>("timeout", 10);
        timer_ = nh.createTimer(ros::Duration(1.0), &Sendtimeout::timerCallback, this);
    }
