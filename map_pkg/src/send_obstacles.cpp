...
{
public:
    Sendobstacles(ros::NodeHandle &nh)
    {
        pub_ = nh.advertise<obstacles_msgs::ObstacleArrayMsg>("obstacles", 10);
        timer_ = nh.createTimer(ros::Duration(1.0), &Sendobstacles::timerCallback, this);
    }
